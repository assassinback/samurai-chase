...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public static string coins5000 = "coins5000";
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        {
            PlayerPrefs.SetInt("currentCoins", PlayerPrefs.GetInt("currentCoins")+1000);
        ...
        else if (String.Equals(args.purchasedProduct.definition.id, coins5000, StringComparison.Ordinal))
        {
            ...
            PlayerPrefs.SetInt("currentCoins", PlayerPrefs.GetInt("currentCoins") + 5000);
            // The consumable item has been successfully purchased, add 100 coins to the player's in-game score.
            //ScoreManager.score += 100;
        }
        ...
        {
            PlayerPrefs.SetInt("noads", 1);
            PlayerPrefs.SetInt("currentCoins", PlayerPrefs.GetInt("currentCoins") + 10000);
            // The consumable item has been successfully purchased, add 100 coins to the player's in-game score.
            //ScoreManager.score += 100;
        }
